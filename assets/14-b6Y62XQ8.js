import{c as e,h as t,i as n,m as r,p as i,r as a,t as o}from"./index-C5hKS9zq.js";var s=14,c=`For Loop`,l=`Array(42).fill().map(...).join('')`,u=Array.from(Array(42).keys()).map(()=>`answer`).join(``),d=`
${e()}
