import{i as r,S as e}from"./index-CMYgftrP.js";const s=7;const p="Functions";const t=[];function n(){r(s,t);add([sprite(e.player),pos(0,36),area(),e.player]);add([sprite(e.exit),pos(center().x,500),area(),e.exit]);add([text("Move me")])}const c=`
/**
