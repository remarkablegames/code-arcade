import{i as r,S as e}from"./index-DVVOSnAK.js";const a=7;const p="Functions";let t;function n(){r(a,t);add([sprite(e.player),pos(0,36),area(),e.player]);add([sprite(e.exit),pos(center().x,500),area(),e.exit]);add([text("Move me")])}const i=`
/**
